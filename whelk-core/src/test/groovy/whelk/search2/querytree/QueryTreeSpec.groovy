...
class QueryTreeSpec extends Specification {
    ...
    def "back to query string"() {
        ...
        "x OR y"                                           | "x OR y"
        "(x OR y) z"                                       | "(x OR y) z"
        "findcategory:\"https://id.kb.se/term/ktg/X\""     | "\"librissearch:workCategory\":\"https://id.kb.se/term/ktg/X\""
        "identifycategory:\"https://id.kb.se/term/ktg/Y\"" | "\"librissearch:workCategory\":\"https://id.kb.se/term/ktg/Y\""
