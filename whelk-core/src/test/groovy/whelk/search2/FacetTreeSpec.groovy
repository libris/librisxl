...
//    }
    ...
    /// TESTS CHECKING FOR SUPERCLASS IN OBJECT.SUBCLASSOF
...
//        observations                                                        | sorted
//        [["object": ["@id": "parent"]],
//         ["object": ["@id": "child", "subClassOf" : [["@id": "parent"]]]]]    | [["object": ["@id": "parent"], "_children": [["object": ["@id": "child", "subClassOf" : [["@id": "parent"]]]]]]]
//    }
//
//    def "Sort one parent with two children"() {
//        expect:
...
//        observations            | sorted
//        [["object": ["@id": "parent"]],
//         ["object": ["@id": "child1", "subClassOf" : [["@id": "parent"]]]],
//         ["object": ["@id": "child2", "subClassOf" : [["@id": "parent"]]]]]    |   [["object": ["@id": "parent"],
//                                                                                     "_children": [["object" : ["@id": "child1", "subClassOf" : [["@id": "parent"]]]],
//                                                                                                   ["object" : ["@id": "child2", "subClassOf" : [["@id": "parent"]]]]
//                                                                                     ]]]
//    }
//
//    def "Sort one parent with one child that has one child"() {
...
//        [["object": ["@id": "parent"]],
//         ["object": ["@id": "child1", "subClassOf" : [["@id": "parent"]]]],
//         ["object": ["@id": "child2", "subClassOf" : [["@id": "child1"]]]]]    |   [["object": ["@id": "parent"],
//                                                                                     "_children": [["object": ["@id": "child1", "subClassOf" : [["@id": "parent"]]],
//                                                                                                    "_children": [["object": ["@id": "child2", "subClassOf" : [["@id": "child1"]]]]]]]]]
//    }
//
//    def "One parent, one between, one child"() {
//        expect:
//        def tree = new FacetTree(jsonLd)
//        tree.sortObservationsAsTree(observations) == sorted
//
...
//        observations                                                           | sorted
//        [["object": ["@id": "parent"]],
//         ["object": ["@id": "child1", "subClassOf" : [["@id": "parent"]]]]]    |   [["object": ["@id": "parent"],
//                                                                                     "_children": [["object": ["@id": "child1", "subClassOf" : [["@id": "parent"]]]
//                                                                                                   ]]]]
//    }
