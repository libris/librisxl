...
public class DocumentComparator2 {
    ...
    public DocumentComparator2() {
        this(o -> "termComponentList".equals(o));
    }

    public DocumentComparator2(Function<Object, Boolean> isOrderedList) {
    ...
    private class UnorderedListComparator {
        ...
        private boolean isSubset(int ixA, int ixB) {
            if (cache[ixA][ixB] == null) {
                cache[ixA][ixB] = DocumentComparator2.this.isSubset(a.get(ixA), b.get(ixB), null);
            }
