...
public class Phase1 {
    record AstModifier(String name, String comparitor, String compareTo) {}
    record AstBooleanGroup(String op, List<AstModifier> modifiers) {}
    record AstRelation(String comparitor, List<AstModifier> modifiers) {}
    record AstSearchClause(String index, AstRelation relation, String term) {}
    record AstScopedClause(Object scopedClause, AstBooleanGroup booleanGroup, Object searchClause ) {}

    public static Object reduce(cqlParser.CqlContext cql) {
