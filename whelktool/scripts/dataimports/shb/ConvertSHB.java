...
// Example usage:
// $ java -cp importers/build/libs/xlimporter.jar -Dxl.secret.properties=DEV2-secret.properties whelktool/scripts/dataimports/shb/ConvertSHB.java ~/Downloads/shb_alfanum_marc > /var/tmp/shb_alnum.jsonld.lines
public class ConvertSHB {
  public static void main(String[] args) throws Exception {
    var converter = MarcFrameCli.newMarcFrameConverter();
