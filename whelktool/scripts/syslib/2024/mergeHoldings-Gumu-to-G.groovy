...
// these forms:
//final List<String> bibIds = ["fsfdrznkc00q2tc9"]
List<String> bibIds = new File(scriptDir, "gumu-id.txt").readLines()

// Define which libraries/sigel are concerned.
final String libraryToMoveFrom = "https://libris.kb.se/library/Gumu"
final String libraryToMoveTo = "https://libris.kb.se/library/G"
...
final List<String> propertiesToMoveToFirstComponent = ["shelfMark", "physicalLocation", "shelfControlNumber", "shelvingControlNumber", "hasNote", "copyNumber", "cataloguersNote", "shelfLabel"]
...
final List<String> propertiesToMerge = ["hasComponent", "marc:hasHold949", "marc:hasTextualHoldingBibliographicUnit", "associatedMedia"]
