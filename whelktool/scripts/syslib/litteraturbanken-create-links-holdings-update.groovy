...
File input = new File(scriptDir, "littbanken_hold_link_update.csv")
...
for (String operation : ProgramLines) {
    ...
    String url = part[1].trim()
    String epub = part[2].trim()
    String omslagsbild = part[3].replace("(större)","").trim()
