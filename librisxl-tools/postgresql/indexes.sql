...
CREATE INDEX idx_lddb_thing_identifiers on lddb using gin ((data#>'{@graph,1,identifiedBy}'));
CREATE INDEX idx_lddb_record_identifiers on lddb using gin ((data#>'{@graph,0,identifiedBy}'));
