...
CLASSPATH=$HOME/dist/legacy_import-1.1-alpha.jar:$HOME/lib/xalan.jar:$HOME/lib/xercesImpl.jar:$HOME/lib/serializer.jar:$HOME/lib/xml-apis.jar:$HOME/lib/marc.jar:$HOME/lib/ojdbc14.jar:$HOME/lib/batchcat.jar:$HOME/lib/isbntools.jar
