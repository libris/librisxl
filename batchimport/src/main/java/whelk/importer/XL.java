        ...
        else if (duplicateIDs.size() == 1) // merge, keep or replace
        {
            ...
            // merge
                ...
                if (m_parameters.getReadOnly()) {
                    ...
                    m_whelk.storeAtomicUpdate(idToMerge, false, false, false, IMPORT_SYSTEM_CODE, m_parameters.getChangedBy(), (Document existing) -> {
    ...
    private String importNewRecord(MarcRecord marcRecord, String collection, String relatedWithBibResourceId, String replaceSystemId)
    {
        ...
        if (!m_parameters.getReadOnly())
        {
            ...
            if (replaceSystemId != null)
            {
                try
                {
                    m_whelk.storeAtomicUpdate(replaceSystemId, false, false, false, IMPORT_SYSTEM_CODE, m_parameters.getChangedBy(),
                            (Document doc) ->
                    {
