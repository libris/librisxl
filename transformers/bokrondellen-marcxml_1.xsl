...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--<collection>-->
		...
		<xsl:variable name="spr">
			<xsl:choose>
				<xsl:when test="sprak and sprak != ''"><xsl:value-of select="sprak"></xsl:value-of></xsl:when>
				<xsl:otherwise>Svenska</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
...
<controlfield tag="008">
	<xsl:choose>
		<xsl:when test="laromedel = 'Ja'">
			<xsl:choose>
			<xsl:when test="bandtyp = 'CD PC' or bandtyp = 'Diskett' or bandtyp = 'Multimedia' or bandtyp = 'Online'">
				<xsl:value-of select="concat($f008_00-05, $f008_06-10, '&#32;&#32;&#32;&#32;', 'sw', '&#32;', '||||', ' ', 's' ,'&#32;&#32;&#32;&#32;', '|00| 0|', normalize-space($lang), '&#32;&#32;')"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="concat($f008_00-05, $f008_06-10, '&#32;&#32;&#32;&#32;', 'sw', '&#32;', '||||', ' ', '&#32;' ,'&#32;&#32;&#32;&#32;', '|00| 0|', normalize-space($lang), '&#32;&#32;')"/>
			</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
		<xsl:otherwise>
			...
			<xsl:otherwise>
				<xsl:value-of select="concat($f008_00-05, $f008_06-10, '&#32;&#32;&#32;&#32;', 'sw', '&#32;', '||||', '&#32;', '&#32;' ,'&#32;&#32;&#32;&#32;', '|00| 0|', normalize-space($lang), '&#32;&#32;')"/>
                    ...
                    <!-- 020/022 -->
                    <!-- ISBN10 -->
                    <xsl:if test="isbn10 and string-length(isbn10)">
                        <datafield tag="020" ind1=" " ind2=" ">
                            <subfield code="a"><xsl:value-of select="isbn10"/> <xsl:value-of select="$bandtyp"/></subfield>
                        </datafield>
                    </xsl:if>
                    
                    <!-- ISBN13/ISSN -->
                    <xsl:choose>
                        <xsl:when test="string-length(artikelnummer) = 13">
                            <datafield tag="020" ind1=" " ind2=" ">
			...
			<subfield code="l"><xsl:value-of select="$spr"/></subfield>
                    </datafield>
	            </xsl:if>
		    ...
		    <!-- 245 -->
                    ...
                    <!-- 250,  050720 PHH-->
		    <xsl:if test="upplagenummer and upplagenummer != '' and upplagenummer!='0' and upplagenummer!='1'">
                    <datafield tag="250" ind1=" " ind2=" ">
                        <subfield code="a"><xsl:value-of select="upplagenummer"/>. uppl.</subfield>                        
                    </datafield>
		    </xsl:if>
