...
public class InvalidLanguageMapValueError extends JsonLdError {
  public InvalidLanguageMapValueError() { };
  public InvalidLanguageMapValueError(String msg) { super(msg); };
}
