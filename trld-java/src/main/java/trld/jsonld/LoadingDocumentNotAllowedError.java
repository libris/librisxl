...
public class LoadingDocumentNotAllowedError extends JsonLdError {
  public LoadingDocumentNotAllowedError() { };
  public LoadingDocumentNotAllowedError(String msg) { super(msg); };
}
