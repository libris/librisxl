...
public class LoadingRemoteContextFailedError extends JsonLdError {
  public LoadingRemoteContextFailedError() { };
  public LoadingRemoteContextFailedError(String msg) { super(msg); };
}
