...
public class InvalidLanguageTaggedStringError extends JsonLdError { // LINE: 39
  InvalidLanguageTaggedStringError() { };
  InvalidLanguageTaggedStringError(String msg) { super(msg); };
}
