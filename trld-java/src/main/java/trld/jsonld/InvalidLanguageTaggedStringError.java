...
public class InvalidLanguageTaggedStringError extends JsonLdError {
  public InvalidLanguageTaggedStringError() { };
  public InvalidLanguageTaggedStringError(String msg) { super(msg); };
}
