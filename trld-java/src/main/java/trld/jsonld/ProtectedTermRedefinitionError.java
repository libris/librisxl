...
public class ProtectedTermRedefinitionError extends JsonLdError {
  public ProtectedTermRedefinitionError() { };
  public ProtectedTermRedefinitionError(String msg) { super(msg); };
}
