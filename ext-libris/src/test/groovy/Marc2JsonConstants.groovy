...
interface Marc2JsonConstants {
    ...
    static def ISBN_LD_0 = ["isbn":"9100563226", "isbnNote": "(inb.)"]
    ...
    static def ISBN_LD_2 = ["isbn":"9100563226", "isbnNote": "(inb.)", "termsOfAvailability":["literal":"310:00"]]
    ...
    static def ISBN_LD_5 = ["isbn":"9100563226", "isbnNote": "(inb.)", "termsOfAvailability":["literal":"310:00"], "deprecatedIsbn":"foo"]
    ...
    static def PUBLISHER_LD_0   = ["placeOfPublication":["@type":"Place", "label":"Stockholm"], "publisher":["@type":"Organization","name":"Bonnier"], "pubDate":["@type":"year","@value":"1996"], "placeOfManufacture":["@type":"Place","label":"Finland"]]
